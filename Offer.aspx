<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Offer.aspx.vb" Inherits="Offer" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
    <div class="col-xs-12 col-sm-2 col-md-2 " style="text-align:center  "  >
        شماره تلفن ثابت:<uc1:help runat="server" ID="help2" />
    </div> 
    <div class="col-xs-12 col-sm-2 col-md-2"  >
    ...
    <div class="col-xs-12 col-sm-2 col-md-2"  >
        <asp:TextBox ID="txtMobile" CssClass="textbox " Width="100%"  runat="server"></asp:TextBox>
    </div> 
         
    </div>
        <div class="row">
        <div class="col-xs-12 col-sm-2 col-md-2" style="text-align:center "  >
            متن انتقاد یا پیشنهاد:<uc1:help runat="server" ID="help4" />
        </div> 
