...
#Region "  Utils"
    ...
    Public Class Utils
        ...
        End Function
        Function Encrypt(ByVal text As String, ByVal Key As String)
            Dim skey As New Data(Key)
        ...
        End Function
        Function Decrypt(ByVal hexstream As String, ByVal Key As String)
            Try
                Dim skey As New Data(Key)
                Dim sym As New Encryption.Symmetric(Encryption.Symmetric.Provider.Rijndael)
