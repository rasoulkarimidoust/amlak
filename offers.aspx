<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="offers.aspx.vb" Inherits="offers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="msgBoxContent" Runat="Server">
    <div id="divDetail" runat="server"  visible="false" >
        ...
        <br /><br />
        <center>
        <asp:Button ID="btnAnswer" runat="server"  class="MyBtn" Text="پاسخ" />
        <asp:Button ID="btnArchive" runat="server"  class="MyBtn" Text="بایگانی" />
        <asp:Button ID="btnDelete" runat="server"  class="MyBtn" Text="حذف" />
        <asp:Button ID="btnOk" runat="server" class="MyBtn"  Text="تائید" />
