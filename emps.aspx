<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="emps.aspx.vb" Inherits="offers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="msgBoxContent" Runat="Server">
    <div id="divDetail" runat="server"  visible="false" >
        ...
        <br />
        <asp:TextBox ID="txtRes" CssClass="textbox " Height="50px" TextMode="MultiLine"  Width="100%" runat="server"></asp:TextBox>
        <br />
        <center>
