<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Recent.aspx.vb" Inherits="Neshan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
        ...
        <asp:LinkButton ID="lbtnDelcookie" runat="server">حذف همه تاریخچه</asp:LinkButton>
	<div class="row">
			...
			<div class="ads">
				...
				<div class="stars">
                    ...
                    <img src="img/play.png" style="height:20px; width:20px; margin-top:-5px; display:<%# DisplayHasFilm(Container.DataItem("Filmdar").ToString())%> "  />
                				...
                				<div class="title-ads">
                                    <asp:LinkButton ID="LinkButton1" OnClick="LinkButtonClick" CommandArgument=<%# Container.DataItem("prjid").ToString()%> runat="server">حذف از تاریخچه</asp:LinkButton>
</div> 
			</div>
            		</div>
